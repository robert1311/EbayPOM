...
public class HomePage extends Header {
	...
	@FindBy(how = How.LINK_TEXT, using = "Saved")
	WebElement savedLink;
	@FindBy(how = How.LINK_TEXT, using = "Motors")
	...
	@FindBy(how = How.LINK_TEXT, using = "Collectibles & Art")
	WebElement collectiblesAndArtLink;
	@FindBy(how = How.LINK_TEXT, using = "Home & Garden")
	WebElement homeAndGardenLink;
	@FindBy(how = How.LINK_TEXT, using = "Sporting Goods")
	WebElement sportingGoodsLink;
	@FindBy(how = How.LINK_TEXT, using = "Toys")
	WebElement toysLink;
	@FindBy(how = How.LINK_TEXT, using = "Business & Industrial")
	WebElement businessAndIndustrialLink;
	@FindBy(how = How.LINK_TEXT, using = "Music")
	WebElement musicLink;
	@FindBy(how = How.LINK_TEXT, using = "Deals")
	WebElement dealsLink;
	@FindBy(how = How.XPATH, using = "//*[@id=\'items_list1\']/div[1]/div/div[1]/h2/a")
	WebElement todaysDealsLink;
	@FindBy(how = How.XPATH, using = "//select[@id='gh-cat']")
	WebElement searchByCategoryDropdown;
